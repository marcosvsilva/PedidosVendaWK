object FNovoPedidosVenda: TFNovoPedidosVenda
  Left = 0
  Top = 0
  Caption = 'FNovoPedidosVenda'
  ClientHeight = 1044
  ClientWidth = 1761
  Color = clBtnFace
  ...
  object pnlPrincipal: TPanel
    ...
    object pnlDetalhes: TPanel
      ...
      object edtValorDesconto: TNumberBox
        ...
        Margins.Bottom = 6
        TabOrder = 2
        SpinButtonOptions.ButtonWidth = 34
    ...
    object pnlGridPanels: TPanel
      ...
      ExplicitWidth = 1745
      ExplicitHeight = 459
      object pnlGridBuscaProduto: TPanel
        Left = 1
        Top = 1
        Width = 1757
        Height = 190
        ...
        Margins.Bottom = 6
        TabOrder = 0
        object stgPesquisaProdutos: TStringGrid
          Left = 1
          Top = 1
          Width = 1755
          Height = 188
      ...
      object pnlGridProdutosPedido: TPanel
        Left = 1
        Top = 289
        Width = 1757
        Height = 170
        ...
        ExplicitTop = 288
        ExplicitWidth = 1743
        object stgProdutosPedido: TStringGrid
          Left = 1
          Top = 1
          Width = 1755
          Height = 168
    ...
    object pnlTotalizadores: TPanel
      ...
      object edtTotalDesconto: TNumberBox
        Left = 1124
        Top = 1
        Width = 242
        Height = 68
